...
const baseUrl = process.env.CAFFEINE_API_URL ||
...
exports.config = {
    ...
    update_download_url: process.env.UPDATE_DOWNLOAD_URL || "",
    update_store_url: process.env.UPDATE_STORE_URL || "",
    update_changelog: process.env.UPDATE_CHANGELOG || "",
